...
const activities = [
	{ type: ActivityType.Custom, name: 'Servers', state: `Lurking in ${client.guilds.cache.size} servers` },
	{ type: ActivityType.Custom, name: 'Members', state: `Supervising ${client.users.cache.size} members` },
